...
getwd()
setwd('D:/R/riii/hw') #資料夾所在目錄
load("lvr_prices_big5.RData")
data <- read.table("D:/R/riii/lvr_prices_big5.RData", header = TRUE, sep = ",")
rm(list=ls())
...
head("lvr_prices_big5.RData")
str("lvr_prices_big5.RData")
names("lvr_prices_big5.RData")


lvr_prices_big5 = lvr_prices_big5[,1]

ls()
class("lvr_prices_big5.RData")
typeof("lvr_prices_big5.RData")

#(3) 請問可使用哪個函式觀看資料前10筆資料？[5分]


head(lvr_prices_big5.RData,10)
